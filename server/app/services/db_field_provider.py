...
from app.services.price_adjuster import AdjusterError, PriceAdjuster
...
_RESOLUTIONS: Final[dict[str, FieldResolution]] = {
    ...
    # ----- M0 데이터 미보유 — 정식 N/A (placeholder 코드 아님) -----
    "dividend_per_share_trailing_annual": FieldResolution(
        field="dividend_per_share_trailing_annual", kind="unsupported_m0",
        note="주당배당 집계 (corporate_actions cash_dividend) 미합류 — 별도 cycle",
    ),
